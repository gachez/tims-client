      ...
      <div style={{ 
        ...
        display: props.show ? 'flex' : 'none'
         ...
         <Modal.Header closeButton onClick={() => props.handleClose()}>
                <Modal.Title style={{fontSize: '1.85rem', fontWeight: 'bolder', width: '100%',textAlign: 'left'}} > {props.contactPerson}: {props.designation} - {props.organisation}({props.industry}) </Modal.Title>
            </Modal.Header>
            <Modal.Body 
              style={{
                display: 'grid',
            ...
            >
               <div style={detailCard}>
                <div style={{display: 'flex',width: 'fit-content', alignItems: 'center'}}>
                  <img src={user} alt="contact person" width="32px" height="32px" />
              ...
              <div style={detailCard}>
                <div style={{display: 'flex',width: 'fit-content', alignItems: 'center'}}>
                  <img alt="Contact telephone" src={phone} width="32px" height="32px" />
              ...
              <div style={detailCard}>
                <div style={{display: 'flex',width: 'fit-content', alignItems: 'center'}}>
                  <img alt="Email address" src={email} width="32px" height="32px" />
              ...
              <div style={detailCard}>
                <div style={{display: 'flex',width: 'fit-content', alignItems: 'center'}}>
                  <img alt="Designation" src={suitcase} width="32px" height="32px" />
              ...
              <div style={detailCard}>
                <div style={{display: 'flex',width: 'fit-content', alignItems: 'center'}}>
                  <img src={organization} alt="org" width="32px" height="32px"  />
              ...
              <div style={detailCard}>
                <div style={{display: 'flex',width: 'fit-content', alignItems: 'center'}}>
                  <img src={factory} alt="ind" width="32px" height="32px" />
                  <h3 style={detailTitle} >Industry</h3></div>
                <span style={detailText} >{props.industry}</span>
              </div>
              <div style={detailCard}>
                <div style={{display: 'flex',width: 'fit-content', alignItems: 'center'}}>
                  <img alt="website" src={web} width="32px" height="32px" />
              ...
              <div style={detailCard}>
                <div style={{display: 'flex',width: 'fit-content', alignItems: 'center'}}>
                  <img alt="Organisation Contacts" src={phone} width="32px" height="32px" />
              ...
              <div style={detailCard}>
                <div style={{display: 'flex',width: 'fit-content', alignItems: 'center'}}>
                  <img alt="location" src={location} width="32px" height="32px" />
              ...
              <div style={detailCard}>
                <div style={{display: 'flex',width: 'fit-content', alignItems: 'center'}}>
                  <img alt="Project name" src={project} width="32px" height="32px" />
